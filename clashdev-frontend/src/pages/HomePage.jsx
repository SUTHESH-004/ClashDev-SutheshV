...
const HomePage = () => {
  return (
    <>
      ...
      <div className="h-[80vh] w-[100vw] flex flex-col-reverse md:flex-row ">
        <div className="h-[100vh] flex-[3] flex justify-center items-center">
          <LeaderBoardBar></LeaderBoardBar>
        </div>
        <div className="h-[60vh] md:h[100%] md:h-[100vh] w-[100%] md:flex-[4]  flex flex-col bg-black">
          <div className=" h-[40vh] md:h-[50%] w-[100%] flex justify-center items-center">
            <div
          ...
          <div className="h-[20vh] md:h-[50%] w-[100%] flex flex-row justify-center align-middle gap-5">
            <div
